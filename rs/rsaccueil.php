		...
		<div class="acrsmiddle">
			...
			<div id="bmcards-container">
				<?php foreach($first15Cards as $card) { ?>
					<div class="bmcard" data-htid="<?= $card['ht_id'] ?>">
						<div class="bmcard_head">
							...
							<div class="bmcard_head_child">
								...
								<?php if(+$card['ht_author'] === +$_SESSION['user_id'] || (isset($_SESSION['isAdmin']) && $_SESSION['isAdmin'] === 1)) { ?>
...
?>
	...
	<script src="../js/ht_edit_modals.js"></script>
	<script src="../js/color_checkbox.js"></script>
	<script src="../js/ht_picinput_icon.js"></script>
